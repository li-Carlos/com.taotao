...
public class TestJedis {
	...
	public void testJedis() throws Exception {
		...
		Jedis jedis = new Jedis("192.168.8.106", 6379);
		//直接操作数据库
	...
	@Test
	public void testJedisGet() throws Exception {
		//创建一个数据库连接池对象（单例），需要指定服务的ip和端口号
		JedisPool jedisPool = new JedisPool("192.168.8.106", 6379);
		//从连接池中获得连接
		Jedis jedis = jedisPool.getResource();
		//使用Jedis操作数据库（方法级别使用）
	...
	public void testJedisCluster() throws Exception {
		...
		//向集合中添加节点
		nodes.add(new HostAndPort("192.168.8.106", 6379));
		nodes.add(new HostAndPort("192.168.8.106", 6380));
		nodes.add(new HostAndPort("192.168.8.106", 6381));
