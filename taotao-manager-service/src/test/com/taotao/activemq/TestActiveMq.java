...
public class TestActiveMq {
	...
	public void testQueueProducer() throws Exception {
		...
		ConnectionFactory connectionFactory = new ActiveMQConnectionFactory("tcp://192.168.8.106:61616");
		...
		TextMessage textMessage = session.createTextMessage("hello activemq22222");
		//8.发送消息
	...
	@Test
	public void testTopicConsumser2() throws Exception {
		//创建一个连接工厂对象
		ConnectionFactory connectionFactory = new ActiveMQConnectionFactory("tcp://192.168.8.106:61616");
		//使用连接工厂对象创建一个连接
		Connection connection = connectionFactory.createConnection();
	...
	@Test
	public void testTopicConsumser3() throws Exception {
		//创建一个连接工厂对象
		ConnectionFactory connectionFactory = new ActiveMQConnectionFactory("tcp://192.168.8.106:61616");
		//使用连接工厂对象创建一个连接
		Connection connection = connectionFactory.createConnection();
